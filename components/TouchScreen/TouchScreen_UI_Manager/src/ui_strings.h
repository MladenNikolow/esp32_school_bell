...
typedef enum {
    ...
    /* --- Setup wizard --- */
    STR_WIZARD_CHOOSE_LANG,
    STR_WIZARD_CHOOSE_LANG_DESC,
    STR_WIZARD_SET_PIN,
    STR_WIZARD_SET_PIN_DESC,
    STR_WIZARD_CONFIRM_PIN,
    STR_WIZARD_PIN_MISMATCH,
    STR_WIZARD_PIN_SET_OK,
    STR_WIZARD_WIFI_TITLE,
    STR_WIZARD_WIFI_DESC,
    STR_WIZARD_FINISH,
    STR_WIZARD_NEXT,
    STR_WIZARD_PIN_LENGTH,
    STR_WIZARD_DIGITS,
    STR_WIZARD_ENTER_PIN,
    STR_WIZARD_SKIP_WIFI,
    STR_WIZARD_SETUP_WIFI,
